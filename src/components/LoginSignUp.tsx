...
const LoginSignUp = () => {
  ...
  const handleOAuthLoginTest = async (provider: "google" | "linkedin") => {
    try {
      ...
      console.log(`${provider} api endpoint: `, apiEndpoint);
            ...
            <div dir="ltr" data-orientation="horizontal">
              ...
              >
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium" htmlFor="signup-usertype">
                      I am a
                    </label>
                    <button
                      type="button"
                      ...
                      <div className="absolute z-50 mt-1 bg-popover text-popover-foreground rounded-md border shadow-md bg-white">
                        <div className="p-1">
                          ...
                          <button
                            type="button"
                            className="w-full text-left px-2 py-1.5 text-sm rounded-sm hover:bg-accent hover:text-accent-foreground"
                            onClick={() => handleUserTypeSelect("Individual Founder")}
                          >
                            Individual Founder
                          </button>
                          <button
